...
allure generate report\reportsAllure\allure-results --output C:\Users\dmefr\OneDrive\Escritorio\Proyecto_Python_Selenium\src\report\reportsAllure\allure-report --clean
